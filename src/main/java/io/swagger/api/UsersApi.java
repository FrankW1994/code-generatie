...
public interface UsersApi {
    ...
    @ApiOperation(value = "Add a new user", nickname = "addUser", notes = "", authorizations = {
    ...
    ResponseEntity<Void> addUser(@ApiParam(value = "created users" ,required=true )  @Valid @RequestBody User body
);
